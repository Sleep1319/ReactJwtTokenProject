...
@Query("SELECT  new com.apiboad6.reactjwttokenproject.dto.sign.SignInQueryResult (m.id, m.email, m.username, m.nickname, m.password, r.roleName) FROM Member m JOIN m.roles r WHERE m.email = :email")
